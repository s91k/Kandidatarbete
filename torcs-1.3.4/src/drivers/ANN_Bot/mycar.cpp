...
{
    AEROMAGIC = GfParmGetNum(car->_carHandle, ANN_BOT_SECT_PRIV, ANN_BOT_ATT_AMAGIC, (char*)NULL, 1.6f);
	CFRICTION = GfParmGetNum(car->_carHandle, ANN_BOT_SECT_PRIV, ANN_BOT_ATT_FMAGIC, (char*)NULL, 1.0f);
