...
/*
	  if (!TDriver::Qualifying)
      {
        if ((I > 170) && (I < 212))
	    {
		  oPathPoints[I].SpeedFrictionFactor *= 0.95f;
		  oPathPoints[I].BrakeFrictionFactor *= 0.85f;
	    }
        else if ((I > 580) && (I < 680))
	    {
		  //oPathPoints[I].SpeedFrictionFactor *= 0.98f;
		  oPathPoints[I].BrakeFrictionFactor *= 0.9f;
	    }
	  }
*/
/*
	  if (TDriver::Qualifying)
      {
        if ((I > 977) && (I < 1014))
	    {
		  oPathPoints[I].BrakeFrictionFactor *= 1.15f;
	    }
	  }
*/
