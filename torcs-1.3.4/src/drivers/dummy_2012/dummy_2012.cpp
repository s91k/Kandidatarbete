...
static char* botname[NBBOTS] = {(char*)"dummy_2012 1", (char*)"dummy_2012 2"};
static char* botdesc[NBBOTS] = {(char*)"dummy_2012 1", (char*)"dummy_2012 2"};
...
// Module entry point.
extern "C" int dummy_2012(tModInfo *modInfo)
{
  int i;
