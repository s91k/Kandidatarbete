...
static const char* botname[BOTS] = {
	"berniw_Recorder 1", "berniw_Recorder 2", "berniw_Recorder 3", "berniw_Recorder 4", "berniw_Recorder 5",
	"berniw_Recorder 6", "berniw_Recorder 7", "berniw_Recorder 8", "berniw_Recorder 9", "berniw_Recorder 10"
};
...
/* Module entry point */
extern "C" int berniw_Recorder(tModInfo *modInfo)
{
	//char	buffer[BUFSIZE];
