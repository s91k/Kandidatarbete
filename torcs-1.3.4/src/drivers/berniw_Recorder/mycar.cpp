/***************************************************************************
    ...
    version              : $Id: mycar.cpp,v 1.34.2.2 2008/12/31 03:53:53 berniw_Recorder Exp $
...
{
    AEROMAGIC = GfParmGetNum(car->_carHandle, BERNIW_RECORDER_SECT_PRIV, BERNIW_RECORDER_ATT_AMAGIC, (char*)NULL, 1.6f);
	CFRICTION = GfParmGetNum(car->_carHandle, BERNIW_RECORDER_SECT_PRIV, BERNIW_RECORDER_ATT_FMAGIC, (char*)NULL, 1.0f);
